...
vim.api.nvim_set_keymap('n', '<C-j>', ':TmuxNavigateLeft<CR>', { silent = true, noremap = true })
vim.api.nvim_set_keymap('n', '<C-k>', ':TmuxNavigateDown<CR>', { silent = true, noremap = true })
vim.api.nvim_set_keymap('n', '<C-l>', ':TmuxNavigateUp<CR>', { silent = true, noremap = true })
vim.api.nvim_set_keymap('n', '<C-p>', ':TmuxNavigateRight<CR>', { silent = true, noremap = true })
