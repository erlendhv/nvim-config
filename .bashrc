...
if command -v tmux &> /dev/null && [ -n "$PS2" ] && [[ ! "$TERM" =~ screen|tmux ]] && [ -z "$TMUX" ]; then
...
spython() {
    # Find the virtual environment in the current directory or parent directories
...
case ":$PATH:" in
    *:/home/erlend-veire/.juliaup/bin:*)
        ;;

    *)
        export PATH=/home/erlend-veire/.juliaup/bin${PATH:+:${PATH}}
        ;;
esac
